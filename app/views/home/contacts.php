    ...
    <form id="contactForm" action="/contacts" method="post" >
        ...
        <div class="form-group">
            ...
            <input type="text" id="fullName" name="ФИО" 
                   value="<?= htmlspecialchars($oldInput['ФИО'] ?? '') ?>" 
        ...
        <div class="form-group">
            ...
            <div class="date-input-wrapper">
                <input type="text" id="birthdate" name="Дата рождения" 
                       value="<?= htmlspecialchars($oldInput['Дата рождения'] ?? '') ?>" 
        ...
        <div class="form-group">
            ...
            <textarea id="message" name="Сообщение" rows="6" 
                      ...
                      data-popover="<h4>Требования к сообщению</h4><p>Сообщение должно содержать не менее 10 символов и быть информативным.</p>"><?= htmlspecialchars($oldInput['Сообщение'] ?? '') ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="tel" id="phone" name="Контактный телефон" 
                   value="<?= htmlspecialchars($oldInput['Контактный телефон'] ?? '') ?>" 
